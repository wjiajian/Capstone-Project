...
class MyMainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # 读取YAML文件
        with open(os.path.join(self.ProjectPath, "code/yolov5_ocsort/yolov5_62/data/CrowdHuman.yaml"), "r", encoding='utf8') as file:
            data = yaml.safe_load(file)
        '''with open(os.path.join(self.ProjectPath, "code/yolov5_ocsort/yolov5_62/data/voc.yaml"), "r", encoding='utf8') as file:
            data = yaml.safe_load(file)'''
...
if __name__ == "__main__":
    weights = 'code/yolov5_ocsort/yolov5_62/runs/train/exp_CrowdHuman/weights/best.pt'
    #weights = 'code/yolov5_ocsort/weights/yolov5s.pt'
    #weights = 'code/yolov5_ocsort/yolov5_62/runs/train/exp_SE,H,V/weights/best.pt'
    device = '0'
    conf_thres = 0.4
    classes = None
    # none为所有目标
