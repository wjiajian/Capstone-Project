...
roadlabels = r"D:\jiajian\School\Capstone_project\code\yolov5_ocsort\yolov5_62\datasets\CrowdHuman\val\labels\xml"
roadimages = r"D:\jiajian\School\Capstone_project\code\yolov5_ocsort\yolov5_62\datasets\CrowdHuman\val\images\val"
fpath = r"C:\Users\jiajian233\Downloads\annotation_val.odgt"
...
for i0, item0 in enumerate(bbox):
    ...
    for i1, item1 in enumerate(gtboxes):
        ...
        nm.appendChild(doc.createTextNode('hbox'))  # 类名: fbox
        ...
        object = doc.createElement('object')
        nm = doc.createElement('name')
        nm.appendChild(doc.createTextNode('vbox'))  # 类名: vbox
        object.appendChild(nm)
        pose = doc.createElement('pose')
        pose.appendChild(doc.createTextNode("Unspecified"))
        object.appendChild(pose)
